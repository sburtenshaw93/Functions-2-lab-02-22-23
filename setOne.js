...
// CODE HERE
const dogParks = (park1, park2) => console.log(`The first park is ${park1} and the second park is ${park2}`)
...
greeting("Sarah", "Burtenshaw", (fullName) => console.log(`Hello, my full name is ${fullName}`));
...
// CODE HERE
const multiplyingFactory = (number1) => {
    return (number2) => {
        if(number1 >= 5){
